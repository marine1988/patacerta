      ...
      <Card className="prose max-w-3xl mx-auto p-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            A PataCerta é responsável pelo tratamento dos dados pessoais
            recolhidos através desta plataforma, em conformidade com o
            Regulamento Geral sobre a Proteção de Dados (RGPD) — Regulamento
            (UE) 2016/679.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            Os dados são tratados para: gestão de contas de utilizador,
            verificação de criadores, comunicação entre utilizadores,
            moderação de conteúdo, cumprimento de obrigações legais e melhoria
            dos serviços.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed mt-2">
            Pode exercer estes direitos através do painel de utilizador ou
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            Os dados pessoais são conservados enquanto a conta estiver ativa.
            Após a eliminação da conta, os dados são pseudonimizados conforme
            exigido por lei, mantendo registos de auditoria por um período
            máximo de 5 anos.
          </p>
        </section>
