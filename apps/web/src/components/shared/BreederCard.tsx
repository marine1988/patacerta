  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-surface-alt">
        <ImageFallback src={cover} alt={businessName} variant="breeder" className="h-full w-full" />
        {status === 'VERIFIED' && (
      ...
      <div className="card-body">
        <h2 className="line-clamp-2 text-base font-semibold text-ink">{businessName}</h2>
        ...
        {avgRating != null && (
          <div className="mt-1.5 flex items-center gap-1.5 text-sm">
            ...
            {reviewCount != null && <span className="text-subtle">({reviewCount})</span>}
          </div>
        )}
