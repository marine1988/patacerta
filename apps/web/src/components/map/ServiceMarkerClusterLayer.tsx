    ...
    markers.forEach((m) => {
      ...
      marker.bindPopup(
        `<div style="min-width:200px">
          ...
          <a href="/servicos/${m.id}" data-spa-link="/servicos/${m.id}" style="display:inline-block;margin-top:10px;font-size:13px;font-weight:500;color:#2563eb;text-decoration:none;cursor:pointer">Ver anúncio →</a>
        </div>`,
