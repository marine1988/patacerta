...
export function FeaturedBadge() {
  return (
    <span className="absolute left-2 top-2 inline-flex items-center gap-1 rounded-sm bg-caramel-500 px-2 py-0.5 text-[10px] font-medium uppercase tracking-caps text-white shadow-sm">
